...
class TournamentProfileAdapterPerson : RecyclerView.Adapter<TournamentProfileAdapterPerson.TournamentViewHolder> {
    ...
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): TournamentViewHolder {
        val view: View = LayoutInflater.from(p0.context)
            .inflate(R.layout.item_list_tournament_on_profile_person, p0, false)
    ...
    inner class TournamentViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            llProfile = itemView.findViewById(R.id.llpP)
            imageProfile = itemView.findViewById(R.id.profilePanitiaOnPP)
            tv_name = itemView.findViewById(R.id.namePanitiaonPP)
            tv_nameT = itemView.findViewById(R.id.nameTonPP)
            brosur = itemView.findViewById(R.id.brosurTonPP)
            tv_category = itemView.findViewById(R.id.categoryTonPP)
            tv_domisili = itemView.findViewById(R.id.domisiliTonPP)
            tv_peserta = itemView.findViewById(R.id.pesertaTonPP)
            tv_tersisa = itemView.findViewById(R.id.tersisaTonPP)
            ikut = itemView.findViewById(R.id.ikutTourP)
        }
    }
